...
st.markdown(
    ...
    /* ============================================================
       ...
       Same tokens as the portfolio's styles.css: accent #246bfe,
       Inter font, 22px radius, soft shadow. CSS only — no widget
       logic below this block was touched.
       ============================================================ */
    ...
    :root {
        ...
        --accent-soft: #eaf1ff;
        --radius: 22px;
        --shadow: 0 18px 55px rgba(15, 34, 69, 0.08);
    }
    ...
    .stApp {
        background: radial-gradient(circle at 15% 5%, var(--accent-soft) 0, transparent 28rem), var(--bg);
        color: var(--text);
    }
    ...
    /* Reskin Streamlit's own widgets to match, via stable data-testid
       selectors — nothing here changes what the widgets do. */
    ...
    [data-testid="stAlert"] {
        ...
        border: 1px solid var(--line) !important;
        box-shadow: 0 12px 35px rgba(15, 34, 69, .045);
    }
